		...
		*/
		...
		if ($tabbed):
			...
			?><ul id="bookedAppointmentTabs" class="bookedClearFix">
				<?php if (booked_user_role() != 'booked_booking_agent'): ?><li<?php if (!$calendar_id): ?> class="active"<?php endif; ?>><a href="#calendar-default"><?php _e('Default Calendar','booked'); ?></a></li><?php endif;
