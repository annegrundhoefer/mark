		...
		<tbody><?php
			...
			for($i = 1; $i <= $rows; $i++){
				...
				for($x = 1; $x <= 7; $x++){
					...
					$html .= '<span class="date'.($appointments_left ? ' tooltipster" title="'.sprintf( _n('%d time slot','%d time slots',$appointments_left,'booked'), $appointments_left) : '"').'"><span class="number">'. $date .'</span></span>';
					$html .= '</td>';
...
function booked_fe_calendar_date_square($date,$calendar_id = false){
	...
	echo '<span class="date'.($appointments_left ? ' tooltipster" title="'.sprintf( _n('%d time slot','%d time slots',$appointments_left,'booked'), $appointments_left) : '"').'"><span class="number">'. $this_day .'</span></span>';
	echo '</td>';
