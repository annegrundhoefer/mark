				...
				<div id="booked-general" class="tab-content">
					...
					<div class="section-row cf">
						<div class="section-head">
							...
							<input id="<?php echo $option_name; ?>" name="<?php echo $option_name; ?>"<?php echo $hide_hide_end_times ? ' checked="checked"' : ''; ?> type="checkbox">
							<label class="checkbox-radio-label" for="<?php echo $option_name; ?>"><?php _e('Redirect users (except Administrators and Booking Agents) from "/wp-admin/" back to the profile page (if set) or homepage (if no profile page is set).','booked'); ?></label>
